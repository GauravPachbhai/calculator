...
function sendNum(digit){
	...
	for(i=0; i<num.length ; i++){
		...
		a = a + num[i];				// concatenate the elements of the array "num" into a single string, which will be screened on the screen
		
	}

document.getElementById('screen').innerHTML = a;	// screening the concatenated string
